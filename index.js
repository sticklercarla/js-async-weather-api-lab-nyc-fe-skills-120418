const API_KEY = "6ad24868cfe3c52b03bcd9ddc5c7b75b"

// 1. Need an eventListener for 'submit'
// 2. Get what they typed in and thend fetch the data for that city from the API
...
function displayFiveDayForecast(json) {
  ...
  for (let forecast of json.list) {
    // 3 things: we want the day, the low, the high 
